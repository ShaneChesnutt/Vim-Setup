...
vim.keymap.set('n', '<leader>fj', builtin.find_files, { desc = "Telescope: Find Files" })
vim.keymap.set('n', '<leader>fg', builtin.git_files, { desc = "Telescope: Search Git Files" })
vim.keymap.set('n', '<leader>fs', builtin.live_grep, { desc = "Telescope: Live Grep" })
vim.keymap.set('n', '<leader>fb', builtin.buffers, { desc = "Telescope: Seach Buffers" })
...
vim.keymap.set('n', '<leader>km', builtin.keymaps, { desc = "Telescope: Key Mappings" })
